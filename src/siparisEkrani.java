...
public class siparisEkrani extends javax.swing.JFrame {
    ...
    public siparisEkrani() {
        initComponents();
        Giris grs = new Giris();
        lblKullanici.setText("Sn. " + grs.name+" "+grs.surName);
        dataDoldur();
    }
    ...
    public void dataDoldur(){
        ...
        tbl.addColumn("Durum");
        String durum1 = "Yolda";
        String durum2 = "Hazırlanıyor";
        String durum3 = "";
        String selectQuery = "select * from siparisler where durum='"+durum1+"' or durum='"+durum2+"' or durum='"+durum3+"'";
        try {
            DB db = new DB();
            ...
            String reason ="Class: siparisEkrani, Function: dataDoldur --- ";
             Giris grs = new Giris();
    ...
    private void initComponents() {
        ...
        lblKullanici.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 24)); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Sipariş Durumu"));

        jButton2.setText("Hazırlanıyor");
        ...
        jButton5.setText("Yeni Sipariş Ver");
        ...
        jButton6.setText("Sipariş Arşivi");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Aktif Siparişler"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       String durum = "Hazırlanıyor";
        int rowNumber = tblData.getSelectedRow();
       int colNumber = 5;
       int id = Integer.valueOf(""+tblData.getValueAt(rowNumber,0));
        String updateQuery="update siparisler set durum='"+durum+"' where sid='"+id+"'";
        
        try {
            DB db = new DB();
            int writeResult =db.baglan().executeUpdate(updateQuery);
        } catch (Exception e) {
             String reason ="Class: siparisEkrani, Buton : Hazırlanıyor --- ";
             Giris grs = new Giris();
             grs.hataYaz(reason,e);
        }
        dataDoldur();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       int id = Integer.valueOf(""+tblData.getValueAt(rowNumber,0));
        ...
        try {
            ...
            String reason ="Class: siparisEkrani, Buton : Yolda --- ";
             Giris grs = new Giris();
             grs.hataYaz(reason,e);
        }
        dataDoldur();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       int id = Integer.valueOf(""+tblData.getValueAt(rowNumber,0));
        ...
        try {
            ...
            String reason ="Class: siparisEkrani, Buton : Tamamlandı --- ";
             Giris grs = new Giris();
             grs.hataYaz(reason,e);
        }
        dataDoldur();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      siparisArsiv sa = new siparisArsiv();
      sa.setVisible(true);
      dispose();
